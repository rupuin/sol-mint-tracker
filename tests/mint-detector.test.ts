...
import type { MintDetected, DetectionFailed } from "../src/events.ts";
import type { LogReceived, StreamFailed, LogSource } from "../src/providers/index.ts";
...
function streamFailed(overrides: { source: LogSource; error: Error }): StreamFailed {
  return {
    context: "stream",
    timestamp: Date.now(),
    ...overrides,
